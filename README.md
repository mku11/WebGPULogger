...
// add the debug layout entry to your entries
let layoutEntries = [
...
// add the debug shader to your shader
let shader = "..."; // this is your shader
...
// add the debug buffer bind entry to your entries
const bindEntries = [
	{binding: 0, resource: {buffer: buffer}}
];
logger.addDebugBindEntry(bindGroupEntries);

// set the commandEncoder
logger.setCommandEncoder(commandEncoder);

// after submitting the job you can retrieve and print the log device.queue.submit([commandEncoder.finish()]);
